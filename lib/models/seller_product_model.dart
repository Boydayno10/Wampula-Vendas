...
class SellerProductModel {
  ...
  // Imagem específica para banner horizontal (opcional)
  String? bannerImage;
  String description;
  String category;
  // Subcategoria específica da categoria (FK lógica para category_subcategories)
  ...
  SellerProductModel({
    ...
    this.storeLongitude,
    this.storeAddress,
    this.descriptionAlignment = 'left',
    this.descriptionBold = false,
    this.descriptionItalic = false,
  ...
  SellerProductModel copyWith({
    ...
    Object? categorySubcategoryId = _Undefined,
    ...
    return SellerProductModel(
      ...
      ageGroups: ageGroups == _Undefined
          ? this.ageGroups
          : ageGroups as List<String>?,
      storageOptions: storageOptions == _Undefined
          ? this.storageOptions
          : storageOptions as List<String>?,
      pantSizes: pantSizes == _Undefined
          ? this.pantSizes
          : pantSizes as List<String>?,
      shoeSizes: shoeSizes == _Undefined
          ? this.shoeSizes
          : shoeSizes as List<String>?,
      ...
      categorySubcategoryId: categorySubcategoryId == _Undefined
          ? this.categorySubcategoryId
          : categorySubcategoryId as String?,
      storeLatitude: storeLatitude == _Undefined
          ? this.storeLatitude
          : storeLatitude as double?,
      storeLongitude: storeLongitude == _Undefined
          ? this.storeLongitude
          : storeLongitude as double?,
      storeAddress: storeAddress == _Undefined
          ? this.storeAddress
      ...
      descriptionItalic: descriptionItalic ?? this.descriptionItalic,
    );
  }
}
