...
class ProductAnalyticsService {
  ...
  static Future<void> logSearch({
    ...
    try {
      ...
      print('📊 Registrando pesquisa: "$searchTerm" ($resultsCount resultados)');
  ...
  static Future<List<Map<String, dynamic>>> getMostPopularProducts({
    ...
    try {
      print('📊 Buscando produtos mais populares${category != null ? " em $category" : ""}');
  ...
  static Future<List<Map<String, dynamic>>> getBestSellingProducts({
    ...
    try {
      print('📊 Buscando produtos mais vendidos${category != null ? " em $category" : ""}');
  ...
  static Future<List<Map<String, dynamic>>> getNewProducts({
    ...
    try {
      print('📊 Buscando produtos novos (últimos $days dias)${category != null ? " em $category" : ""}');
  ...
  static Future<List<Map<String, dynamic>>> getPopularSearchTerms({
    ...
    try {
      ...
      print('✅ ${(result as List).length} termos encontrados');
      return List<Map<String, dynamic>>.from(result);
    } catch (e) {
