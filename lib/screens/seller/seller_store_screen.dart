...
class _SellerStoreScreenState extends State<SellerStoreScreen> {
  ...
  Future<void> _loadProducts() async {
    // Antes de carregar os produtos, garante que o dono ainda é vendedor.
    // Se o perfil deixou de ser vendedor, a loja fica indisponível.
    try {
      ...
      final isSeller = profiles != null && profiles['is_seller'] == true;
      ...
      final sellerProducts =
          await SellerProductService.getProductsBySeller(widget.sellerId);
      if (!mounted) return;
      setState(() {
