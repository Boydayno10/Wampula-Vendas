            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      CurrencyUtils.formatMt(widget.price),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if (widget.hasSizeOption &&
                      widget.availableSizes != null &&
                  ...
                  if (widget.hasColorOption &&
                      widget.availableColors != null &&
                  ...
                  if (widget.hasAgeOption &&
                      widget.availableAgeGroups != null &&
                      widget.availableAgeGroups!.isNotEmpty) ...[
                    _sectionTitle("Idade"),
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                  ...
                  if (widget.hasStorageOption &&
                      widget.availableStorageOptions != null &&
                      widget.availableStorageOptions!.isNotEmpty) ...[
                  ...
                  if (widget.hasPantSizeOption &&
                      widget.availablePantSizes != null &&
                      widget.availablePantSizes!.isNotEmpty) ...[
                  ...
                  if (widget.hasShoeSizeOption &&
                      widget.availableShoeSizes != null &&
                      widget.availableShoeSizes!.isNotEmpty) ...[
