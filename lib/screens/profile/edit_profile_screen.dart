...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  bool _isInitialized = false; // Flag para evitar recarregamento múltiplo
  ...
  // Recarregar perfil do Supabase antes de editar
  Future<void> _reloadProfile() async {
    if (AuthService.isLoggedIn) {
      // Recarrega o perfil do banco de dados
      await AuthService.reloadCurrentUserProfile();
      print('🔄 Perfil recarregado na tela de edição');
    }
  }
  ...
  void didChangeDependencies() {
    ...
    // Só carrega os dados UMA VEZ para evitar sobrescrever alterações do usuário
    if (_isInitialized) {
      print('⏭️ didChangeDependencies chamado novamente - ignorando para preservar alterações do usuário');
      return;
    }
    ...
    if (args != null) {
      ...
      print('👤 Carregando dados do usuário para edição:');
      ...
      if (_bairrosDisponiveis.contains(user.bairro)) {
        ...
        print('✅ Bairro válido selecionado: $_selectedBairro');
      } else {
        _selectedBairro = 'Piloto'; // Fallback para valor válido
        print('⚠️ Bairro inválido "${user.bairro}", usando Piloto');
      }
  ...
  void _saveProfile() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (isCreatingAccount) {
        ...
        print('   Bairro selecionado: $_selectedBairro');
        print('   Foto: $uploadedProfileImageUrl');
                ...
                onChanged: (value) {
                  if (value != null) {
                    setState(() {
                      ...
                      print('🔄 Bairro alterado no dropdown: $_selectedBairro');
                    });
                  }
                },
              ),
